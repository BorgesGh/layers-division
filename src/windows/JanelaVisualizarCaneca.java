 ...
 * @author Giovany
 */
public class JanelaVisualizarCaneca {

    protected ControladoraCanecas controladora;
    ...
    protected Vector obterNomeColunasTabela() {
        if (colunas == null) {
            ...
            colunas.addElement("Beleza");
            colunas.addElement("Cor");
    ...
    protected void limparTabelaCanecas() {
        for (int i = 0; i < 25; i++) {
            System.out.println();
        }
    }

    protected void preencherTabelaCanecas() {
        try {
            Vector linhas;
            linhas = controladora.obterLinhasCanecas(coluna, crescente);
            ...
            for (int i = 0; i < numLinhas; i++) {
                ...
                String valor = "" + (Double) linha.get(colunas.size() - 1);
                if (valor.equals("")) {
            ...
            Logger.getLogger(JanelaVisualizarCaneca.class.getName()).log(Level.SEVERE, null, ex);
    ...
    protected void montarLayout() {
        ...
        System.out.println("===========================================================================================================");
        // Preenchendo a Tabela de Canecas
        this.preencherTabelaCanecas();
    }

    public JanelaVisualizarCaneca() {
        controladora = new ControladoraCanecas();
